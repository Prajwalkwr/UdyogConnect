    ...
    try {
      if (mode === 'login') {
        ...
        Swal.fire({
          icon: 'success',
          title: translate('Success!', 'सफल भयो!'),
          text: translate('Registration completed. Please sign in.', 'दर्ता पूरा भयो। कृपया लगइन गर्नुहोस्।'),
        });
        setMode('login');
      } else if (mode === 'forgot') {
          ...
          {mode === 'login' && (
            <div className="rounded-2xl border border-slate-800 bg-slate-950/40 p-3 space-y-2">
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                <button
                  type="button"
                  onClick={() => handleQuickLogin('admin@udyog.np', 'password', 'Admin')}
                  disabled={loading}
                ...
                <button
                  type="button"
                  onClick={() => handleQuickLogin('seller@udyog.np', 'password', 'Business')}
                  disabled={loading}
