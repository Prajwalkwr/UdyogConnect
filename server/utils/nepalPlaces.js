...
const UNIQUE_PLACES = [...new Set(NEPAL_PLACES.map((p) => p.trim()).filter(Boolean))];
...
module.exports = {
  NEPAL_PLACES: UNIQUE_PLACES.sort((a, b) => a.localeCompare(b)),
  isNepalPlace,
  normalizePlaceToken,
};
